...
const DropOffListScreen = () => {
  ...
  const defaultVanImage = Image.resolveAssetSource(
    require("../../../assets/defaultVan.png")
  ).uri;
  ...
  const handleBusPress = (item, index) => {
    navigation.navigate("DropOffRoute", { id: item.id });
  };
...
export default DropOffListScreen;
